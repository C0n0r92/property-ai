-- Add yield_estimate column to rental_listings table
ALTER TABLE rental_listings ADD COLUMN IF NOT EXISTS yield_estimate NUMERIC;

-- Update the consolidate_property_data function to fix the UPDATE statement
