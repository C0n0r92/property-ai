...
interface AreasIndexClientProps {
  areaStats: AreaStats[];
}

export default function AreasIndexClient({ areaStats }: AreasIndexClientProps) {
        ...
        {paginatedAreas.map((area, index) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <h2 className="font-semibold text-lg text-[var(--foreground)]">{area.name}</h2>
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex justify-between">
                <span className="text-sm text-[var(--muted-foreground)]">Price per m2</span>
                <span className="font-semibold text-[var(--foreground)]">EUR{area.avgPricePerSqm.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[var(--border)] text-left text-[var(--muted-foreground)] text-sm">
                ...
                <th className="pb-3 font-medium text-right">EUR/sqm</th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 text-right font-mono text-[var(--muted-foreground)]">
                      {area.avgPricePerSqm > 0 ? `EUR${area.avgPricePerSqm.toLocaleString()}` : 'N/A'}
                    </td>
