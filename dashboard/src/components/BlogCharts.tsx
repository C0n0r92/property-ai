...
export function PropertySizeInvestmentEfficiencyChart() {
  return (
    <ChartWrapper>
      <div className="my-8">
        <div className="h-80 mb-4">
        ...
        <div className="h-80 mb-4">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Tooltip
                formatter={(value) => value ? [`€${Math.round(Number(value)).toLocaleString()}`, "Price"] : ['€0', "Price"]}
              />
        ...
        <div className="h-80 mb-4">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                formatter={(value, name) => {
                  if (name === "Starting Price") return value ? [`€${Math.round(Number(value)).toLocaleString()}`, name] : ['€0', name];
                  return value ? [Number(value) + "%", name] : ['0%', name];
                }}
              />
        ...
        <div className="h-80 mb-4">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Tooltip
                formatter={(value) => value ? [`€${Math.round(Number(value)).toLocaleString()}`, "Average Price"] : ['€0', "Average Price"]}
              />
              <Bar dataKey="averagePrice" fill="#DC2626" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
