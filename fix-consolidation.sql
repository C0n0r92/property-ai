-- Fix the consolidation function and ensure table exists

-- Create consolidated_properties table if it doesn't exist
...
-- Create yield calculation function if it doesn't exist
