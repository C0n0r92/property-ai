...
console.log(`=== D7 AREA DEEP DIVE ANALYSIS ===\n`);
console.log(`Total D7 properties analyzed: ${validProps.length.toLocaleString()}`);
...
console.log(`2024 D7 properties: ${props2024.length}`);
console.log(`2025 D7 properties: ${props2025.length}\n`);
...
console.log('🏘️ D7 PROPERTY TYPES');
console.log('====================');
...
console.log('📈 D7 MONTHLY PRICE TRENDS');
console.log('===========================');
...
console.log('💰 D7 PRICE DISTRIBUTION');
console.log('=========================');
...
console.log('🎯 D7 BIDDING WAR ANALYSIS');
console.log('===========================');
...
const chartDataPath = path.join(__dirname, '../blogs/blog20_d7_area_deep_dive_chart_data.json');
fs.writeFileSync(chartDataPath, JSON.stringify(chartData, null, 2));

console.log(`\n📊 Chart data exported to: ${chartDataPath}`);
console.log('\n✅ D7 Area Analysis Complete!');
