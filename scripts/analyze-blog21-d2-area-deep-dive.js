...
console.log(`=== D2 AREA DEEP DIVE ANALYSIS ===\n`);
console.log(`Total D2 properties analyzed: ${validProps.length.toLocaleString()}`);
...
console.log(`2024 D2 properties: ${props2024.length}`);
console.log(`2025 D2 properties: ${props2025.length}\n`);
...
console.log('🏘️ D2 PROPERTY TYPES');
console.log('====================');
...
console.log('📈 D2 MONTHLY PRICE TRENDS');
console.log('===========================');
...
console.log('💰 D2 PRICE DISTRIBUTION');
console.log('=========================');
...
console.log('🎯 D2 BIDDING WAR ANALYSIS');
console.log('===========================');
...
const chartDataPath = path.join(__dirname, '../blogs/blog21_d2_area_deep_dive_chart_data.json');
fs.writeFileSync(chartDataPath, JSON.stringify(chartData, null, 2));

console.log(`\n📊 Chart data exported to: ${chartDataPath}`);
console.log('\n✅ D2 Area Analysis Complete!');
